        ...
        <div class="col-lg-5 px-5 pb-2 pt-5 mt-2  border border-dark rounded-3">
            <form method="post" action="/employee" enctype="multipart/form-data">
                ...
                <div class="mb-1">
                    ...
                    <input type="text" maxlength="50" class="form-control @error('tmplahir') is-invalid @enderror"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" maxlength="255" class="form-control @error('kota') is-invalid @enderror"
