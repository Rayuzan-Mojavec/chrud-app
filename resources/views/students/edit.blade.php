...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center">
        <div class="col-lg-5 px-5 pb-2 pt-5 mt-2  border border-dark rounded-3">
            <form method="post" action="/student/{{ $student->nis }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="mb-1">
                    <label for="nis" class="form-label">NIS</label>
                    <input type="text" maxlength="10" class="form-control @error('nis') is-invalid @enderror"
                ...
                <div class="mb-1">
                    ...
                    <input type="text" maxlength="100" class="form-control @error('tmplahir') is-invalid @enderror"
                        id="tmplahir" name="tmplahir" value="{{ $student->tmplahir }}">
                    @error('tmplahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control @error('tgllahir') is-invalid @enderror" id="tgllahir"
                        name="tgllahir" value="{{ $student->tgllahir }}">
                    @error('tgllahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" maxlength="100" class="form-control @error('kota') is-invalid @enderror"
                        id="kota" name="kota" value="{{ $student->kota }}">
                    @error('kota')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
